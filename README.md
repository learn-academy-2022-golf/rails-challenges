...
This repository holds the Rails pair programming challenges for the Golf 2022 cohort.
...
- Branch name: `topic-initials1-initials2` (ex. params-aw-sp)
- Project name: `topic-student1-student2` (ex. params-austin-sarah)
...
### Cloning an Existing Rails App
Use these command if this is the first time you have worked in the Rails app locally (aka you didn't run `rails new`):
- $ `bundle`
- $ `yarn`
- $ `rails db:create`
- $ `rails db:migrate`
...
- $ `git checkout -b <topic-initials1-initials2>` (ex. params-aw-sp)
